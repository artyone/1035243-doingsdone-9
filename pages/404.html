    ...
    <div class="container">
      ...
      <div class="content">
        <section class="welcome">
          <h2 class="welcome__heading">Страница не найдена</h2>

          <div class="welcome__text">
            <p>Пожалуйста, вернитесь назад или перейдите на главную страницу.</p>
          </div>

          <a class="welcome__button button" href="../index.php">Перейти на главную</a>
        </section>
      </div>
    </div>
  </div>
